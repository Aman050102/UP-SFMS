...
urlpatterns = [
    ...
    path(
        "staff/badminton/",
        views.staff_badminton_booking,
        name="staff_badminton_booking",
    ),
    # --- User ---
    ...
    path(
        ...
        views.equipment_return_page,
        name="user_equipment_return",
    ),
    ...
    path(
        "export/borrow-stats.csv",
        views.export_borrow_stats_csv,
        name="export_borrow_stats_csv",
    ),
    # --- Monthly Report ---
    path(
        "reports/monthly/<int:year>/<int:month>/",
        views.monthly_report_page,
        name="monthly_report",
    ),
    path(
        "api/reports/monthly/<int:year>/<int:month>.json",
        views.api_monthly_report,
        name="api_monthly_report",
    ),
    path(
        "reports/monthly/<int:year>/<int:month>/source.pdf",
        views.monthly_report_source_pdf,
        name="monthly_report_source_pdf",
    ),
    path(
        "api/reports/monthly/<int:year>/<int:month>/pdf-info.json",
        views.api_monthly_pdf_info,
        name="api_monthly_pdf_info",
    ),
    path(
        "reports/monthly/<int:year>/<int:month>/viewer/",
        views.monthly_report_viewer,
        name="monthly_report_viewer",
    ),
    path(
        "reports/monthly/<int:year>/<int:month>/build/",
        views.monthly_report_build_pdf,
        name="monthly_report_build_pdf",
    ),
    path(
        "reports/monthly/<int:year>/<int:month>/public/",
        views.monthly_report_page_public,
        name="monthly_report_public",
    ),
    # --- Staff APIs ---
    path(
        "api/staff/equipments/", views.api_staff_equipments, name="api_staff_equipments"
    ),
    path(
        "api/staff/equipment/<int:pk>/",
        views.api_staff_equipment_detail,
        name="api_staff_equipment_detail",
    ),
    path(
        "api/staff/borrow-records/",
        views.api_staff_borrow_records,
        name="api_staff_borrow_records",
    ),
    # --- Misc ---
